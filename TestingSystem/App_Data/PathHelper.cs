...
namespace TestingSystem.Helpers
{
    public class PathHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        //public static string GetConnectorFilePath()
        //{
        //    var applicationDirectoryPath = GetApplicationDirectoryPath();
        //    if (string.IsNullOrEmpty(applicationDirectoryPath))
        //        return string.Empty;

        //    return Path.Combine(applicationDirectoryPath, Common.Constants.FileNames.DatabaseConnector);
        //}
        ...
        public static string GetServerPath()
        {
            ...
            DataRow[] dr_temp = dtInstanceNames.Select("InstanceName = 'EIEXPRESS' ");
            if (dr_temp.Length > 0)
            {
        ...
        {
            string PatternImagePath = Path.Combine(GetDirectoryPathOfCoreImage(), "PatternFiles\\");
