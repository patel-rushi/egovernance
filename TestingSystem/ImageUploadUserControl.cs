...
namespace TestingSystems
{
    ...
    ToolboxBitmap(typeof(ImageUploadUserControl), "ImageUploadUserControl"),
    DefaultEvent("OnSelectionChanged"),
    DesignerAttribute(typeof(ImageUploadUserControlDesigner), typeof(IDesigner))]
    public partial class ImageUploadUserControl : UserControl
    {
        #region Constants
        ...
        [DefaultValue(typeof(ImageUploadUserControl.StripLocation), BOTTOM)]
        public ImageUploadUserControl.StripLocation ThumbsStripLocation
        {
            ...
            set
            {
                ...
                {
                    case ImageUploadUserControl.StripLocation.Bottom:
                        panelNavigation.Dock = DockStyle.Bottom;
                        mainPicture.Top = 0;
                        break;
                    case ImageUploadUserControl.StripLocation.Top:
        ...
        public ImageUploadUserControl()
        {
            ...
            thumbsStripLocation = ImageUploadUserControl.StripLocation.Bottom;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ImageUploadUserControl_Resize(object sender, EventArgs e)
        {
        ...
        private void Thumbnail_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //if (boxSender.Name.EndsWith(".pdf") == true || boxSender.Name.EndsWith(".PDF") == true)
                //{
                //    mainPicture.Hide();
                //    axUploadPatternPDF.Show();
                //    axUploadPatternPDF.LoadFile(boxSender.Name);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ImageUploadUserControl_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void SelectThumbnail(int imageID)
        {
            ...
            if (imageID != selectedImageID)
            {
                ...
                if (thumbIndex >= 0)
                {
                    ...
                    String text = imagesCollection[imageID].Description;
                    if (text.EndsWith(".pdf") == true || text.EndsWith(".PDF") == true)
                    {
                        mainPicture.Visible = false;
                        axAcroPDF1.LoadFile(text);
        ...
        private int PushThumbnail()
        {
            ...
            newButton.KeyDown += new KeyEventHandler(ImageUploadUserControl_KeyDown);
        ...
        //private void SetButtonStates()
        //{
        //    btnDeletePatternImage.Enabled = (SelectedImageID != ImageUploadUserControl.NO_SELECTION_ID) ? true : false;
        //    //btnFileUpload.Enabled = (imageUploadUserControl1.ImagesCollection.Length > 0) ? true : false;
        //}

        private void btnDeletePatternImage_Click(object sender, EventArgs e)
        {
            if (SelectedImageID > 0)
            {
                int ImageID = SelectedImageID;
                String ImageName = imagesCollection[ImageID].Description;
                ...
                if (File.Exists(pathString + ImageName))
                {
                    System.IO.File.Delete(pathString + ImageName);
                }

                if (ImageID > 0)
                    SelectThumbnail(ImageID - 1);
            }
            else
                System.Windows.Forms.MessageBox.Show("Select Image.");


            SetButtonStates();
        }

        private void btnFileUploads_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == openFileDialog.ShowDialog())
            {
                ...
                {
                    if (file.EndsWith(".pdf") == true || file.EndsWith(".PDF") == true)
                    {

                        axAcroPDF1.Show();
                        //axAcroPDF1.LoadFile(file);
                        mainPicture.Visible = false;
                        Image thisImage = Image.FromFile("D:\\Icon.jpg");
                ...
                //String s = this.Parent.Parent.Parent.Parent.Name;

                //Window parentWindow = Application.Current.MainWindow();

                #region Whatever I select image file, that file also will add into TempCore Folder
                ...
                int tempcount = images.Count -1;
                for (int i = 0; i <= images.Count - 1; i++)
                {
                    if (images[tempcount] != null )
                    {
                        File.Copy(images[tempcount].Description.Split(',')[0].Replace(@"\", "\\"), pathString.Replace(@"\", "\\") + images[tempcount].Description.Split(',')[0].Substring(images[tempcount].Description.Split(',')[0].LastIndexOf("\\") + 1), true);
                    }
                    tempcount--;
                }
        ...
        internal void AddImageRange(string p)
        {
    ...
    public class FilmstripImage
    {
        ...
        public int Id
        {
            ...
            set
            {
                if (ImageUploadUserControl.NO_SELECTION_ID == value)
                {
                    throw new ArgumentOutOfRangeException();
                }
                id = value;
        ...
        {
            id = ImageUploadUserControl.NO_SELECTION_ID;
            image = null;
        ...
        {
            if (ImageUploadUserControl.NO_SELECTION_ID == idValue)
            {
                throw new ArgumentOutOfRangeException();
            }
            id = idValue;
    ...
    {
        /// <summary>
        /// Control designer class for the ImageUploadUserControl
        /// </summary>
        internal class ImageUploadUserControlDesigner : ControlDesigner
        {
            // The list of actions
            ...
            /// </summary>
            public ImageUploadUserControlDesigner()
            {
            }
            ...
            public override DesignerActionListCollection ActionLists
            {
                get
                {
                    ...
                    if (actionList == null)
                    {
                        ...
                        actionList.Add(new ImageUploadUserControlDesignerActionList(this.Component));
                    }
        ...
        ///     Dock
        /// </summary>
        internal class ImageUploadUserControlDesignerActionList : DesignerActionList
        {
            ImageUploadUserControl usercontrol;
            ...
            public ImageUploadUserControlDesignerActionList(IComponent component)
                : base(component)
            {
                usercontrol = component as ImageUploadUserControl;
